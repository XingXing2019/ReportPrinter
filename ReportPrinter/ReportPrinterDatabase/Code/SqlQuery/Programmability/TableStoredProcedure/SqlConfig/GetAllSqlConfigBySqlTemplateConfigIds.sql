IF OBJECT_ID('[dbo].[GetAllSqlConfigBySqlTemplateConfigIds]', 'P') IS NOT NULL
BEGIN
	DROP PROCEDURE [dbo].[GetAllSqlConfigBySqlTemplateConfigIds]
END
GO

CREATE PROCEDURE [dbo].[GetAllSqlConfigBySqlTemplateConfigIds]
