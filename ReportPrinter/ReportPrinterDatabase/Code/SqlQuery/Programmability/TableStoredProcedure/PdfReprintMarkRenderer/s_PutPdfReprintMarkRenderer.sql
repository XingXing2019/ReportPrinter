IF OBJECT_ID('[dbo].[s_PutPdfReprintMarkRenderer]', 'P') IS NOT NULL
BEGIN
	DROP PROCEDURE [dbo].[s_PutPdfReprintMarkRenderer]
END
GO

CREATE PROCEDURE [dbo].[s_PutPdfReprintMarkRenderer]
