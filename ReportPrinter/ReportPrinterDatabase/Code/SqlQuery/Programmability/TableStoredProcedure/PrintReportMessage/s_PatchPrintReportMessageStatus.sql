IF OBJECT_ID('[dbo].[s_PatchPrintReportMessageStatus]', 'P') IS NOT NULL
BEGIN
	DROP PROCEDURE [dbo].[s_PatchPrintReportMessageStatus]
END
GO

CREATE PROCEDURE [dbo].[s_PatchPrintReportMessageStatus]
