...
namespace ReportPrinterDatabase.Code.StoredProcedures.PdfAnnotationRenderer
{
    ...
    {
        public PutPdfAnnotationRenderer(SqlGuid pdfRendererBaseId, byte annotationRendererType, string title, byte? icon, string content, string sqlTemplateId, string sqlId, string sqlResColumn)
        {
