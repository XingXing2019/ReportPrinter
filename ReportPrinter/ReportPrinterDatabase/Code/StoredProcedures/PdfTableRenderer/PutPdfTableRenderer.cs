...
{
    public class PutPdfTableRenderer : StoredProcedureBase
    {
        public PutPdfTableRenderer(Guid pdfRendererBaseId, double? boardThickness, double? lineSpace, byte? titleHorizontalAlignment, bool? hideTitle, double? space, byte? titleColor, double? titleColorOpacity, Guid sqlTemplateConfigSqlConfigId, string sqlVariable, Guid? subPdfTableRendererId)
        {
