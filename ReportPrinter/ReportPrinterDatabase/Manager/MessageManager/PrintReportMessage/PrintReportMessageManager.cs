    ...
    public class PrintReportMessageManager : IPrintReportMessageManager<IPrintReport>
    {
        public async Task Post(IPrintReport message)
        {
            ...
            try
            {
                ...
                Logger.Debug($"Record message: {message.MessageId} into PrintReportMessages table", procName);
            }
            catch (Exception ex)
            {
                Logger.Error($"Exception happened during recording message: {message.MessageId} into PrintReportMessages table. Ex: {ex.Message}", procName);
                throw;
            }
        }
        ...
        public async Task<IPrintReport> Get(Guid id)
        {
            ...
            try
            {
                ...
                Logger.Debug($"Retrieve message: {id} from PrintReportMessages table", procName);
                return message;
            }
            catch (Exception ex)
            {
                Logger.Error($"Exception happened during retrieving message: {id} from PrintReportMessages table. Ex: {ex.Message}", procName);
                throw;
            }
        }
        ...
        public async Task<IList<IPrintReport>> GetAll()
        {
            ...
            try
            {
                ...
                Logger.Debug($"Retrieve all messages from PrintReportMessages table", procName);
                return messages;
            }
            catch (Exception ex)
            {
                Logger.Error($"Exception happened during retrieving all messages from PrintReportMessages table. Ex: {ex.Message}", procName);
                throw;
            }
        ...
        public async Task Put(IPrintReport message)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    entity.ReportType = message.ReportType;
                    ...
                    await context.SaveChangesAsync();
                    Logger.Debug($"Update message: {message.MessageId} in PrintReportMessages table", procName);
                }
            }
            catch (Exception ex)
            {
                Logger.Error($"Exception happened during updating message: {message.MessageId} in PrintReportMessages table. Ex: {ex.Message}", procName);
                throw;
            }
        }
        ...
        public async Task Delete(Guid id)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    await context.SaveChangesAsync();
                    Logger.Debug($"Delete message: {id} from PrintReportMessages table", procName);
                }
            }
            catch (Exception ex)
            {
                Logger.Error($"Exception happened during deleting message: {id} from PrintReportMessages table. Ex: {ex.Message}", procName);
                throw;
            }
